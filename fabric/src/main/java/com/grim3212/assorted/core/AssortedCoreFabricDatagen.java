...
public class AssortedCoreFabricDatagen implements DataGeneratorEntrypoint {
    ...
    public void onInitializeDataGenerator(FabricDataGenerator fabricDataGenerator) {
        ...
        pack.addProvider((output, registriesFuture) -> new FabricItemTagProvider(output, registriesFuture, provider, new CoreItemTagProvider(output, registriesFuture, provider)));
        ...
        pack.addProvider((output, registriesFuture) -> new FabricWorldGenProvider(output, registriesFuture, Constants.MOD_ID, new CoreWorldGenData()));
    }

    @Override
    public void buildRegistry(RegistrySetBuilder registryBuilder) {
        new CoreWorldGenData().addToWorldGem(registryBuilder);
    }

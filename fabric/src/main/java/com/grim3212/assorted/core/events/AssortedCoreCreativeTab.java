...
public class AssortedCoreCreativeTab {
    ...
    private static final CreativeModeTab ASSORTED_CORE_GROUP = FabricItemGroup.builder(new ResourceLocation(Constants.MOD_ID, "tab")).icon(() -> new ItemStack(CoreBlocks.PLATINUM_ORE.get())).build();

    public static void init () {
        ItemGroupEvents.modifyEntriesEvent(AssortedCoreCreativeTab.ASSORTED_CORE_GROUP).register(populator -> {

...
public abstract class AbstractAlloyForgeTileEntity extends TileEntity implements ISidedInventory, INamedContainerProvider, INameable, ITickableTileEntity, IRecipeHolder, IRecipeHelperPopulator {
	...
	protected final IIntArray alloyForgeData = new IIntArray() {
		public int get(int index) {
			...
			case 1:
				return AbstractAlloyForgeTileEntity.this.recipesUsed;
			case 2:
		...
		public void set(int index, int value) {
			...
			case 0:
				...
				break;
			case 1:
				AbstractAlloyForgeTileEntity.this.recipesUsed = value;
				break;
			case 2:
	...
	protected final IRecipeType<AlloyForgeRecipe> recipeType;

	public AbstractAlloyForgeTileEntity(TileEntityType<?> type, IRecipeType<AlloyForgeRecipe> recipeTypeIn) {
		super(type);
	...
	private void combine(@Nullable IRecipe<?> recipe) {

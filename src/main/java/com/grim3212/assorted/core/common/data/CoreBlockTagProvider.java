...
public class CoreBlockTagProvider extends BlockTagsProvider {
	...
	protected void addTags() {
		...
		this.tag(CoreTags.Blocks.ORES).addTag(CoreTags.Blocks.ORES_AMETHYST);
		...
		this.tag(CoreTags.Blocks.ORES_TIN).add(CoreBlocks.TIN_ORE.get());
		this.tag(CoreTags.Blocks.ORES_COPPER).add(CoreBlocks.COPPER_ORE.get());
		this.tag(CoreTags.Blocks.ORES_SILVER).add(CoreBlocks.SILVER_ORE.get());
		this.tag(CoreTags.Blocks.ORES_ALUMINUM).add(CoreBlocks.ALUMINUM_ORE.get());
		this.tag(CoreTags.Blocks.ORES_NICKEL).add(CoreBlocks.NICKEL_ORE.get());
		this.tag(CoreTags.Blocks.ORES_PLATINUM).add(CoreBlocks.PLATINUM_ORE.get());
		this.tag(CoreTags.Blocks.ORES_LEAD).add(CoreBlocks.LEAD_ORE.get());
		this.tag(CoreTags.Blocks.ORES_RUBY).add(CoreBlocks.RUBY_ORE.get());
		this.tag(CoreTags.Blocks.ORES_AMETHYST).add(CoreBlocks.AMETHYST_ORE.get());
		this.tag(CoreTags.Blocks.ORES_SAPPHIRE).add(CoreBlocks.SAPPHIRE_ORE.get());
		this.tag(CoreTags.Blocks.ORES_TOPAZ).add(CoreBlocks.TOPAZ_ORE.get());

		this.tag(CoreTags.Blocks.STORAGE_BLOCKS).add(CoreBlocks.TIN_BLOCK.get());
		this.tag(CoreTags.Blocks.STORAGE_BLOCKS).add(CoreBlocks.COPPER_BLOCK.get());
		...
		this.tag(CoreTags.Blocks.STORAGE_BLOCKS).add(CoreBlocks.AMETHYST_BLOCK.get());
		...
		this.tag(CoreTags.Blocks.STORAGE_BLOCKS_COPPER).add(CoreBlocks.COPPER_BLOCK.get());
		...
		this.tag(CoreTags.Blocks.STORAGE_BLOCKS_AMETHYST).add(CoreBlocks.AMETHYST_BLOCK.get());

...
//	public static Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_ALUMINUM = FeatureUtils.register(CorePlacements.prefix("ore_aluminum"), Feature.ORE, new OreConfiguration(ORE_ALUMINUM_TARGET_LIST, 12));

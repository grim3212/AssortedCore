...
public class CoreConfiguredFeatures {
	...
	public static ConfiguredFeature<?, ?> ORE_ALUMINUM = Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, CoreBlocks.ALUMINUM_ORE.get().getDefaultState(), CoreConfig.COMMON.veinSizeAluminum.get()))
			.withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(CoreConfig.COMMON.botOffsetAluminum.get(), CoreConfig.COMMON.topOffsetAluminum.get(), CoreConfig.COMMON.maxSpawnLevelAluminum.get()))).square().func_242731_b(CoreConfig.COMMON.spawnRateAluminum.get());
	public static ConfiguredFeature<?, ?> ORE_COPPER = Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, CoreBlocks.COPPER_ORE.get().getDefaultState(), CoreConfig.COMMON.veinSizeCopper.get()))
			.withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(CoreConfig.COMMON.botOffsetCopper.get(), CoreConfig.COMMON.topOffsetCopper.get(), CoreConfig.COMMON.maxSpawnLevelCopper.get()))).square().func_242731_b(CoreConfig.COMMON.spawnRateCopper.get());
	public static ConfiguredFeature<?, ?> ORE_NICKEL = Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, CoreBlocks.NICKEL_ORE.get().getDefaultState(), CoreConfig.COMMON.veinSizeNickel.get()))
			.withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(CoreConfig.COMMON.botOffsetNickel.get(), CoreConfig.COMMON.topOffsetNickel.get(), CoreConfig.COMMON.maxSpawnLevelNickel.get()))).square().func_242731_b(CoreConfig.COMMON.spawnRateNickel.get());
	public static ConfiguredFeature<?, ?> ORE_TIN = Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, CoreBlocks.TIN_ORE.get().getDefaultState(), CoreConfig.COMMON.veinSizeTin.get()))
			.withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(CoreConfig.COMMON.botOffsetTin.get(), CoreConfig.COMMON.topOffsetTin.get(), CoreConfig.COMMON.maxSpawnLevelTin.get()))).square().func_242731_b(CoreConfig.COMMON.spawnRateTin.get());
	public static ConfiguredFeature<?, ?> ORE_LEAD = Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, CoreBlocks.LEAD_ORE.get().getDefaultState(), CoreConfig.COMMON.veinSizeLead.get()))
			.withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(CoreConfig.COMMON.botOffsetLead.get(), CoreConfig.COMMON.topOffsetLead.get(), CoreConfig.COMMON.maxSpawnLevelLead.get()))).square().func_242731_b(CoreConfig.COMMON.spawnRateLead.get());
	public static ConfiguredFeature<?, ?> ORE_SILVER = Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, CoreBlocks.SILVER_ORE.get().getDefaultState(), CoreConfig.COMMON.veinSizeSilver.get()))
			.withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(CoreConfig.COMMON.botOffsetSilver.get(), CoreConfig.COMMON.topOffsetSilver.get(), CoreConfig.COMMON.maxSpawnLevelSilver.get()))).square().func_242731_b(CoreConfig.COMMON.spawnRateSilver.get());
	public static ConfiguredFeature<?, ?> ORE_PLATINUM = Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, CoreBlocks.PLATINUM_ORE.get().getDefaultState(), CoreConfig.COMMON.veinSizePlatinum.get()))
			.withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(CoreConfig.COMMON.botOffsetPlatinum.get(), CoreConfig.COMMON.topOffsetPlatinum.get(), CoreConfig.COMMON.maxSpawnLevelPlatinum.get()))).square().func_242731_b(CoreConfig.COMMON.spawnRatePlatinum.get());
	...
	public static ConfiguredFeature<?, ?> ORE_RUBY = Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, CoreBlocks.RUBY_ORE.get().getDefaultState(), CoreConfig.COMMON.veinSizeRuby.get()))
			.withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(CoreConfig.COMMON.botOffsetRuby.get(), CoreConfig.COMMON.topOffsetRuby.get(), CoreConfig.COMMON.maxSpawnLevelRuby.get()))).square().func_242731_b(CoreConfig.COMMON.spawnRateRuby.get());
	public static ConfiguredFeature<?, ?> ORE_SAPPHIRE = Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, CoreBlocks.SAPPHIRE_ORE.get().getDefaultState(), CoreConfig.COMMON.veinSizeSapphire.get()))
			.withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(CoreConfig.COMMON.botOffsetSapphire.get(), CoreConfig.COMMON.topOffsetSapphire.get(), CoreConfig.COMMON.maxSpawnLevelSapphire.get()))).square().func_242731_b(CoreConfig.COMMON.spawnRateSapphire.get());
	public static ConfiguredFeature<?, ?> ORE_TOPAZ = Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, CoreBlocks.TOPAZ_ORE.get().getDefaultState(), CoreConfig.COMMON.veinSizeTopaz.get()))
			.withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(CoreConfig.COMMON.botOffsetTopaz.get(), CoreConfig.COMMON.topOffsetTopaz.get(), CoreConfig.COMMON.maxSpawnLevelTopaz.get()))).square().func_242731_b(CoreConfig.COMMON.spawnRateTopaz.get());
	public static ConfiguredFeature<?, ?> ORE_AMETHYST = Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, CoreBlocks.AMETHYST_ORE.get().getDefaultState(), CoreConfig.COMMON.veinSizeAmethyst.get()))
			.withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(CoreConfig.COMMON.botOffsetAmethyst.get(), CoreConfig.COMMON.topOffsetAmethyst.get(), CoreConfig.COMMON.maxSpawnLevelAmethyst.get()))).square().func_242731_b(CoreConfig.COMMON.spawnRateAmethyst.get());

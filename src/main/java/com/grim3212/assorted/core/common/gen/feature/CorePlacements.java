...
public class CorePlacements {
	...
	public static final Holder<PlacedFeature> ORE_ALUMINUM = PlacementUtils.register(prefix("ore_aluminum"), CoreConfiguredFeatures.ORE_ALUMINUM, commonOrePlacement(CoreConfig.COMMON.spawnRateAluminum.get(), HeightRangePlacement.triangle(VerticalAnchor.absolute(CoreConfig.COMMON.botOffsetAluminum.get()), VerticalAnchor.absolute(CoreConfig.COMMON.maxSpawnLevelAluminum.get()))));
